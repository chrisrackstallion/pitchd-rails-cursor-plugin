...
- **Quick wins:** in-file, low blast radius, fits a follow-up commit in the same
  PR or a tiny chore PR.
- **Significant / separate:** refactors that change **behavior surface**,
  **many files**, **public APIs**, or need **migration / QA** — still **report**
  them; label clearly (see report format).
