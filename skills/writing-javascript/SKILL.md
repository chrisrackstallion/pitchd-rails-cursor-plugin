...
Stimulus controllers earn at most **one canonical system spec per behaviour** — see **`../writing-tests/references/system-specs.md`** § Budget. The simplest page that exercises the controller is the canonical home; other usages assume it works. For an existing fleet of controllers without specs, run **`../refactoring-stimulus-controllers`**.
...
- [../writing-hotwire/references/patterns.md](../writing-hotwire/references/patterns.md) — Turbo/Stimulus behaviour in templates.
- [../refactoring-stimulus-controllers/SKILL.md](../refactoring-stimulus-controllers/SKILL.md) — rebalancing an existing Stimulus fleet and ensuring spec coverage.
- [../writing-tests/references/system-specs.md](../writing-tests/references/system-specs.md) — Five Gates and Budget for JS-driven system specs.
