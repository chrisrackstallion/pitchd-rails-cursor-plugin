...
**`../../writing-javascript/references/patterns.md`** § Stimulus. ERB-side
wiring lives in **`../../writing-hotwire/references/patterns.md`**.
...
If two pages are equally simple, pick the one that exists in plugin examples
