...
Mailer classes, `deliver_later`, `Mailer.with`, and previews: **`agent_harness_rails/skills/writing-mailers/references/patterns.md`**. Below: **RSpec** shape for mail content and enqueueing.
