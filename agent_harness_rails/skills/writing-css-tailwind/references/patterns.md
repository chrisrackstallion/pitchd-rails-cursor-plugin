...
Markup placement (`class_names`, partials, helpers, forms) lives in **`agent_harness_rails/skills/writing-views/references/patterns.md`**. This document covers **build pipeline**, **global CSS**, **config**, and **boundaries** with Hotwire and JS.
...
Field-level error styling and flash markup are **views** concerns — **`agent_harness_rails/skills/writing-views/references/patterns.md`** § Forms. This skill does not duplicate every form example; it enforces **one** theme and **no** duplicate design system in JS.
...
- Pair **`data-*`** hooks with minimal JS — **`agent_harness_rails/skills/writing-hotwire/references/patterns.md`**.
...
- Semantic HTML first; utilities decorate structure. **`agent_harness_rails/skills/writing-views/references/patterns.md`** covers structure; this skill reminds that **contrast** and **visible focus** are non-negotiable.
...
| Need | See |
|------|-----|
| ERB, partials, `class_names`, helpers | `agent_harness_rails/skills/writing-views/references/patterns.md` |
| Turbo, Stimulus behaviour | `agent_harness_rails/skills/writing-hotwire/references/patterns.md` |
| importmap, bundlers, `application.js` | `agent_harness_rails/skills/writing-javascript/references/patterns.md` |
