...
the mailer. See **`agent_harness_rails/rules/services.mdc`**.
...
**`agent_harness_rails/skills/writing-i18n/references/patterns.md`**. Avoid hardcoded copy in one
...
Align with **`agent_harness_rails/rules/testing.mdc`**: **mailer specs** own subject, recipients,
