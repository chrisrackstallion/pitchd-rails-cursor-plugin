...
| Turbo / Hotwire responses | Read `agent_harness_rails/skills/writing-hotwire/references/patterns.md` (canonical); `references/patterns.md` § Response Hierarchy for failed validations |
...
Details match `agent_harness_rails/rules/controllers.mdc` § Response Hierarchy (Hotwire). Frames, streams, Stimulus, and anti-SPA patterns: **`agent_harness_rails/skills/writing-hotwire/references/patterns.md`**.
