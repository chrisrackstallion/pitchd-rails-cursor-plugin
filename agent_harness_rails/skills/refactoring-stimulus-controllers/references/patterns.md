...
**`agent_harness_rails/skills/writing-javascript/references/patterns.md`** § Stimulus. ERB-side
wiring lives in **`agent_harness_rails/skills/writing-hotwire/references/patterns.md`**.
