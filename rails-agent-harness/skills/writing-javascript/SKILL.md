...
Stimulus controllers earn at most **one canonical system spec per behaviour** — see **`rails-agent-harness/skills/writing-tests/references/system-specs.md`** § Budget. The simplest page that exercises the controller is the canonical home; other usages assume it works. For an existing fleet of controllers without specs, run **`../refactoring-stimulus-controllers`**.
...
- [rails-agent-harness/skills/writing-hotwire/references/patterns.md](rails-agent-harness/skills/writing-hotwire/references/patterns.md) — Turbo/Stimulus behaviour in templates.
- [rails-agent-harness/skills/refactoring-stimulus-controllers/SKILL.md](rails-agent-harness/skills/refactoring-stimulus-controllers/SKILL.md) — rebalancing an existing Stimulus fleet and ensuring spec coverage.
- [rails-agent-harness/skills/writing-tests/references/system-specs.md](rails-agent-harness/skills/writing-tests/references/system-specs.md) — Five Gates and Budget for JS-driven system specs.
