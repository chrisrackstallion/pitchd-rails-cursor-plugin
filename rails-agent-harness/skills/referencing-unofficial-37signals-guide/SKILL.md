...
> under **`rails-agent-harness/skills/*/SKILL.md`**. This harness's own rules and skills remain the
...
`rails-agent-harness/rules/*.mdc` — they are the **project** contract. This skill is **optional
...
| `writing-*`, `rails-agent-harness/rules/*.mdc` | **How** we ship in this harness — primary. |
