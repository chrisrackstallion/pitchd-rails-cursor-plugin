...
| Mailer class, templates, previews | Read `rails-agent-harness/skills/writing-mailers/references/patterns.md`; RSpec examples in `references/support-specs.md` § Mailer Specs |
| I18n / asserting on translated copy | Read `rails-agent-harness/skills/writing-i18n/references/patterns.md` § Testing |
