...
Mailer classes, `deliver_later`, `Mailer.with`, and previews: **`rails-agent-harness/skills/writing-mailers/references/patterns.md`**. Below: **RSpec** shape for mail content and enqueueing.
