...
- **Rule (short):** `rails-agent-harness/rules/rubocop.mdc`
- **Philosophy (not lint):** `rails-agent-harness/skills/rails-omakase-compass/SKILL.md`
- **Implementation workflow:** `rails-agent-harness/skills/implementing-rails-task/SKILL.md`
