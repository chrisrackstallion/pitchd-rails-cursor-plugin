...
the mailer. See **`rails-agent-harness/rules/services.mdc`**.

Mailer **templates** follow the same ERB discipline as web views; reuse helpers
and partials where it helps — see **`rails-agent-harness/skills/writing-views/references/patterns.md`**.
...
**`rails-agent-harness/skills/writing-i18n/references/patterns.md`**. Avoid hardcoded copy in one
...
Align with **`rails-agent-harness/rules/testing.mdc`**: **mailer specs** own subject, recipients,
...
**`deliver_later`**. Match the style of **`rails-agent-harness/skills/writing-tests/references/support-specs.md`**.
