...
| Subject / body copy | Read `references/patterns.md` § I18n and subjects; key structure in `rails-agent-harness/skills/writing-i18n/references/patterns.md` § Mailers |
| Async vs sync delivery | Read `references/patterns.md` § Delivery |
| Preview in browser | Read `references/patterns.md` § Previews |
| Mailer spec | Read `references/patterns.md` § Testing; **`rails-agent-harness/skills/writing-tests/references/support-specs.md`** § Mailer Specs |
| Template partials / helpers | **`rails-agent-harness/skills/writing-views/references/patterns.md`** (strict locals where applicable) |
