...
**`rails-agent-harness/skills/writing-i18n/references/patterns.md`** § Active Record labels and errors.
...
Narrative order (redirect → frames → streams), ERB/stream templates, and Stimulus: **`rails-agent-harness/skills/writing-hotwire/references/patterns.md`**. This section documents **model-side** broadcast APIs.
...
transaction. Mailer API and delivery: **`rails-agent-harness/skills/writing-mailers/references/patterns.md`**.
