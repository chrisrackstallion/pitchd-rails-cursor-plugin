...
- **Read `rails-agent-harness/skills/writing-javascript/SKILL.md` and
  `rails-agent-harness/skills/writing-javascript/references/patterns.md`** for the controller anatomy
  and quality rules.
- **Read `rails-agent-harness/skills/writing-hotwire/references/patterns.md`** § Stimulus for the
  ERB-side wiring conventions.
- **Read `rails-agent-harness/skills/writing-tests/references/system-specs.md`** for the Five Gates
  and Budget rules — they govern which controllers get a system spec.
- **Skim `rails-agent-harness/rules/javascript.mdc` and `rails-agent-harness/rules/hotwire.mdc`** for the
  anti-pattern tables.
...
**`rails-agent-harness/skills/writing-tests/references/system-specs.md`** § Budget. Other usages of
...
- **Has multiple specs across pages** — pick the simplest representative
  page; **delete** the duplicates per `rails-agent-harness/skills/writing-tests/references/system-specs.md`
...
Apply the Five Gates from `rails-agent-harness/skills/writing-tests/references/system-specs.md`:
...
- **Do not change server-side behaviour.** If the audit surfaces a controller
  ...
  session per **`rails-agent-harness/skills/implementing-rails-task/SKILL.md`**.
...
`rails-agent-harness/agents/rails-implementor.md` when the work is scoped to a
...
- **Writing controllers from scratch:** `rails-agent-harness/skills/writing-javascript/SKILL.md`
  (`references/patterns.md`)
- **Hotwire wiring in templates:** `rails-agent-harness/skills/writing-hotwire/SKILL.md`
  (`references/patterns.md`)
- **Test-writing conventions:** `rails-agent-harness/skills/writing-tests/SKILL.md`
  (`references/system-specs.md` — Five Gates, Budget)
- **Rebalancing spec layers:** `rails-agent-harness/skills/refactoring-rails-specs/SKILL.md`
- **Rules:** `rails-agent-harness/rules/javascript.mdc`, `rails-agent-harness/rules/hotwire.mdc`,
  `rails-agent-harness/rules/testing.mdc`
- **RuboCop:** `rails-agent-harness/skills/running-rubocop/SKILL.md`
- **Implementor subagent:** `rails-agent-harness/agents/rails-implementor.md`
- **Reviewer skill / subagent:** `rails-agent-harness/skills/reviewing-rails-work/SKILL.md`
- **Compass (only if a philosophy question surfaces):**
  `rails-agent-harness/skills/rails-omakase-compass/SKILL.md`
