...
**Tailwind / global CSS** — add or remove utility classes from Stimulus; do not duplicate a styling architecture here — **`../writing-css-tailwind`**, **`rails-agent-harness/rules/css-tailwind.mdc`**.
...
- [rails-agent-harness/skills/writing-javascript/references/patterns.md](rails-agent-harness/skills/writing-javascript/references/patterns.md) — importmap vs bundling, Stimulus file location, asset pipeline boundary.
