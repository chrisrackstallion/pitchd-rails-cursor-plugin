...
| Turbo / Hotwire responses | Read `rails-agent-harness/skills/writing-hotwire/references/patterns.md` (canonical); `references/patterns.md` § Response Hierarchy for failed validations |
...
Details match `rails-agent-harness/rules/controllers.mdc` § Response Hierarchy (Hotwire). Frames, streams, Stimulus, and anti-SPA patterns: **`rails-agent-harness/skills/writing-hotwire/references/patterns.md`**.
...
- [ ] Response uses the simplest Turbo mechanism (full-page redirect → frames → streams — see `rails-agent-harness/skills/writing-hotwire/references/patterns.md`)
