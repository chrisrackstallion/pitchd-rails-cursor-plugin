...
principle that keeps controllers thin applies here. See **`rails-agent-harness/rules/services.mdc`**
and **`rails-agent-harness/skills/writing-services/SKILL.md`** for where domain logic belongs.
...
**`rails-agent-harness/skills/writing-tests/references/support-specs.md`** § Job Specs
