...
| Async email | Use `deliver_later` — see `rails-agent-harness/rules/mailers.mdc`; the mailer IS the job |
...
| Writing job specs | Read `rails-agent-harness/skills/writing-tests/references/support-specs.md` § Job Specs |
