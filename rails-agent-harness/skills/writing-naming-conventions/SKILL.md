...
Look up the convention in `rails-agent-harness/rules/naming.mdc` for the layer you are working in:

| Layer | Section in `rails-agent-harness/rules/naming.mdc` |
|-------|-------------------------------|
...
Before finalising any name, check the Anti-Patterns table in `rails-agent-harness/rules/naming.mdc`. Most common traps:
...
| Rule / Skill | Role |
|-------------|------|
| `rails-agent-harness/rules/naming.mdc` | Authoritative naming tables — this skill's reference |
| `rails-agent-harness/rules/models.mdc`, `skills/writing-models` | Domain verbs, concern names, scope names |
| `rails-agent-harness/rules/controllers.mdc`, `skills/writing-controllers` | Action names, REST resource naming |
| `rails-agent-harness/rules/routes.mdc`, `skills/writing-routes` | Resource and helper naming |
| `rails-agent-harness/rules/jobs.mdc`, `skills/writing-jobs` | Job class naming pattern |
| `rails-agent-harness/rules/mailers.mdc`, `skills/writing-mailers` | Mailer class and method naming |
| `rails-agent-harness/rules/policies.mdc`, `skills/writing-policies` | Policy class and permission method naming |
| `rails-agent-harness/rules/testing.mdc`, `skills/writing-tests` | Spec, factory, and example naming |
| `rails-agent-harness/rules/services.mdc` | Why there is no `Service` suffix |
