...
| User-facing strings / locales | Read `rails-agent-harness/skills/writing-i18n/references/patterns.md` |
| Tailwind in templates (utilities, partials, `class_names`, helpers) | Read `references/patterns.md` § Tailwind |
| Tailwind pipeline, config, `@apply`, v3/v4, global CSS | Read `rails-agent-harness/skills/writing-css-tailwind/references/patterns.md` |
| Stimulus / Turbo / Hotwire | Read `rails-agent-harness/skills/writing-hotwire/references/patterns.md` |
| Importmap, package.json, JS entrypoints | Read `rails-agent-harness/skills/writing-javascript/references/patterns.md` |
| Layout / content_for | Read `references/patterns.md` § Layouts |
| Form template | Read `references/patterns.md` § Forms |
| Mailer templates (`*_mailer/`) | Read `rails-agent-harness/skills/writing-mailers/references/patterns.md` |
| Turbo Frame/Stream markup | Read `rails-agent-harness/skills/writing-hotwire/references/patterns.md` |
...
For detailed patterns and examples, see [references/patterns.md](references/patterns.md). For Tailwind **build** and **global** styling policy, see [rails-agent-harness/skills/writing-css-tailwind/references/patterns.md](rails-agent-harness/skills/writing-css-tailwind/references/patterns.md).
