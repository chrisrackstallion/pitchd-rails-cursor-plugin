...
| Planning / execution context | `writing-pitchd-rails-plans`, `executing-pitchd-rails-plan`, `implementing-pitchd-rails`, `reviewing-pitchd-rails` | only when the question is about **how** to plan or run those workflows in this plugin |
